...
const initialPeople: UserType[] = [
  ...
  { _id: 1, name: "Александр Матросов", age: 66 },
  { _id: 2, name: "Коля Остен-Бакен", age: 16 },
  { _id: 3, name: "Виктор Хитмэн", age: 44 },
  { _id: 4, name: "Дмитрий Кузюбердин", age: 40 },
  { _id: 5, name: "Ирина Шейк", age: 55 },
];
